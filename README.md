...
|  357 |  计算各个位数不同的数字个数              |**C++/Python**|中等|
|  365 |  水壶问题              |**Python**|中等|
|  397 |  整数替换              |**Python**|中等|    
|  409 |  矩阵置零              |**Python**|中等|    
|  423 |  从英文中重建数字              |**Python**|中等|    
|  429 |  N叉树的层次遍历              |**C++/Python**|中等|    
|  442 |  数组中重复的元素              |**Python**|中等|    
|  451 |  根据字符出现频率排序            |**Python**|中等|  
|  478 |  在圆内随机生成点              |**Python**|中等|    
|  513 |  在每个树行中找最大值           |**Python**|中等|    
|  515 |  找树左下角的值           |**Python**|中等|    
|  537 |  复数乘法           |**Python**|中等|    
|  539 |  最小时间差           |**Python**|中等|    
|  540 |  有序数组中的单一元素           |**Python**|中等|    
|  542 |  01矩阵           |**Python**|中等|    
|  583 |  两个字符串的删除操作            |**Python**|中等|    
...
| 1306 |  跳跃游戏III         |**Python**|中等|
| 1315 |  祖父节点值为偶数的节点和         |**Python**|中等|
| 1318 |  或运算的最小翻转次数         |**Python**|中等|
| 1319 |  连通网络的操作次数         |**Python**|中等|
|---|----|       ----           |简单| --- |
|    1 |  两数之和              |**Python**|空|    
|    7 |  整数反转 |**Python**|空|   
|    9 |  回文数  |**Python**|空|    
...
|  690 |  员工的重要性            |**Python**|简单|    
|  693 |  交替位二进制数            |**Python**|简单|    
...
| 1313 |  解压缩编码列表         |**Python**|简单|
| 1317 |  将整数转换为两个无零整数的和         |**Python**|简单|
