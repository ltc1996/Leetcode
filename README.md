...
[![](https://img.shields.io/badge/LeetCode-256/1303-yellow.svg?style=social&logo=leetcode)](https://leetcode-cn.com/u/ltcccc/)
...
|---| ----| ---- |困难| --- ||   42 | [接雨水](困难/0042%20接雨水.md) | **C++/Python** | 困难 |
...
|---| ----| ---- |中等| --- ||    5 | [最长回文子串](中等/0005%20最长回文子串.md) | **C++/Python** | 中等 |
...
|---| ----| ---- |简单| --- ||    1 | [两数之和](简单/0001%20两数之和.md) | **Python** | 空 |
